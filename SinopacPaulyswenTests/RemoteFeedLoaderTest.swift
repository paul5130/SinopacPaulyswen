...
class RemoteFeedLoaderTests: XCTestCase {
    ...
    private func expect(_ sut: RemoteFeedLoader, toCompleteWith result: RemoteFeedLoader.RemoteFeedLoaderResult, when action: () -> Void, file: StaticString = #file, line: UInt = #line) {
